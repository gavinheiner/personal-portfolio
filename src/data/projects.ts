...
export const projects: ProjectInfo[] = [
  ...
  },
  {
    ...
    detailedDescription: "This web application was built using React with TypeScript and was styled with Tailwind. It is being hosted on Vercel, which enabled me to securely handle back-end tasks like delivering emails via Vercel Functions.",
    cardImage: "/images/personal-portfolio.png",
    detailedImage: "/images/personal-portfolio.png",
    imageScaling: "object-bottom",
