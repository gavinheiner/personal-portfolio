      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block text-gray-400 ml-2 mr-3">|</div>
            <div className="hidden md:flex space-x-4">
              <a href="https://www.github.com/gavinheiner" className="text-gray-400 hover:text-gray-500">
              ...
              <a href="https://www.linkedin.com/in/gavinheiner" className="text-gray-400 hover:text-gray-500">
